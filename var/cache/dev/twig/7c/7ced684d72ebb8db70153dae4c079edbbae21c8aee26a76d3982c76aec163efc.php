...
\t<h3>";
        // line 5
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["proyecto"]) || array_key_exists("proyecto", $context) ? $context["proyecto"] : (function () { throw new Twig_Error_Runtime('Variable "proyecto" does not exist.', 5, $this->source); })()), "nombre", array()), "html", null, true);
        echo "</h3>
\t<figure>
\t\t<img class=\"img-fluid rounded imgIzq\" src=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("build/img/" . twig_get_attribute($this->env, $this->source, (isset($context["proyecto"]) || array_key_exists("proyecto", $context) ? $context["proyecto"] : (function () { throw new Twig_Error_Runtime('Variable "proyecto" does not exist.', 7, $this->source); })()), "foto", array()))), "html", null, true);
        echo "\" alt=\"";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["proyecto"]) || array_key_exists("proyecto", $context) ? $context["proyecto"] : (function () { throw new Twig_Error_Runtime('Variable "proyecto" does not exist.', 7, $this->source); })()), "nombre", array()), "html", null, true);
        echo "\">
\t</figure>

\t";
        // line 10
        echo nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["proyecto"]) || array_key_exists("proyecto", $context) ? $context["proyecto"] : (function () { throw new Twig_Error_Runtime('Variable "proyecto" does not exist.', 10, $this->source); })()), "descripcion", array()), "html", null, true));
        echo "
...
\t\t\t\t\t<a id=\"corazon";
        // line 24
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["proyecto"]) || array_key_exists("proyecto", $context) ? $context["proyecto"] : (function () { throw new Twig_Error_Runtime('Variable "proyecto" does not exist.', 24, $this->source); })()), "id", array()), "html", null, true);
...
";
    ...
    {
        return array (  134 => 46,  127 => 43,  118 => 42,  87 => 24,  70 => 10,  62 => 7,  57 => 5,  54 => 4,  45 => 3,  15 => 1,);
    }
