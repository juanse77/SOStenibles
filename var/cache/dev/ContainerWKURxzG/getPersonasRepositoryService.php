...
// Returns the private 'App\Repository\PersonasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PersonasRepository.php';

return $this->privates['App\Repository\PersonasRepository'] = new \App\Repository\PersonasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
