...
// Returns the private 'App\Repository\EmpresasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EmpresasRepository.php';

return $this->privates['App\Repository\EmpresasRepository'] = new \App\Repository\EmpresasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
