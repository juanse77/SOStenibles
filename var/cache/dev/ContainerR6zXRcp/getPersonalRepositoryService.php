...
// Returns the private 'App\Repository\PersonalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PersonalRepository.php';

return $this->privates['App\Repository\PersonalRepository'] = new \App\Repository\PersonalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
