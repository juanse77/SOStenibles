...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ApadrinamientosRepository' => function () {
    return ($this->privates['App\Repository\ApadrinamientosRepository'] ?? $this->load('getApadrinamientosRepositoryService.php'));
}, 'App\\Repository\\AportacionesRepository' => function () {
    return ($this->privates['App\Repository\AportacionesRepository'] ?? $this->load('getAportacionesRepositoryService.php'));
}, 'App\\Repository\\EmpresasRepository' => function () {
    return ($this->privates['App\Repository\EmpresasRepository'] ?? $this->load('getEmpresasRepositoryService.php'));
}, 'App\\Repository\\LikesRepository' => function () {
    return ($this->privates['App\Repository\LikesRepository'] ?? $this->load('getLikesRepositoryService.php'));
}, 'App\\Repository\\NecesidadesRepository' => function () {
    return ($this->privates['App\Repository\NecesidadesRepository'] ?? $this->load('getNecesidadesRepositoryService.php'));
...
}, 'App\\Repository\\PersonasRepository' => function () {
    return ($this->privates['App\Repository\PersonasRepository'] ?? $this->load('getPersonasRepositoryService.php'));
}, 'App\\Repository\\ProyectosRepository' => function () {
    return ($this->privates['App\Repository\ProyectosRepository'] ?? $this->load('getProyectosRepositoryService.php'));
}, 'App\\Repository\\UsuariosRepository' => function () {
    return ($this->privates['App\Repository\UsuariosRepository'] ?? $this->load('getUsuariosRepositoryService.php'));
}))));
