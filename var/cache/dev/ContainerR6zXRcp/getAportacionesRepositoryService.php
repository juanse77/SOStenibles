...
// Returns the private 'App\Repository\AportacionesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AportacionesRepository.php';

return $this->privates['App\Repository\AportacionesRepository'] = new \App\Repository\AportacionesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
