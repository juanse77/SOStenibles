...
// Returns the private 'App\Repository\ApadrinamientosRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ApadrinamientosRepository.php';

return $this->privates['App\Repository\ApadrinamientosRepository'] = new \App\Repository\ApadrinamientosRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
